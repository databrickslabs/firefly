                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {warehouse.enable_photon && (
                        <div className="flex items-center gap-2 text-muted-foreground">
                          ...
                          <span className="font-medium text-purple-600 dark:text-purple-400">Photon Enabled</span>
                        </div>
                      )}
                      {warehouse.enable_serverless_compute && (
                        <div className="flex items-center gap-2 text-muted-foreground">
                          ...
                          <span className="font-medium text-blue-600 dark:text-blue-400">Serverless</span>
                        </div>
                      )}
