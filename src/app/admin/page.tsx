...
export default function AdminPage() {
  const [stats, setStats] = useState<Stat[]>([
    { label: "Organizations", value: 0, icon: Building2, href: "/admin/organizations" },
    { label: "Orphaned Users", value: 0, icon: UserX, href: "/admin/orphaned-users" },
      ...
      try {
        ...
        if (orgsRes.ok && orphanedRes.ok) {
          ...
          setStats([
            ...
            { label: "Orphaned Users", value: orphaned.length, icon: UserX, href: "/admin/orphaned-users" },
            { label: "Total Users", value: userIds.size + orphaned.length, icon: Users, href: "/admin/users" },
          ]);
        }
      } catch (err) {
    ...
    <div className="p-8 space-y-8">
      ...
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Welcome to the back office operations dashboard
        </p>
      </div>
